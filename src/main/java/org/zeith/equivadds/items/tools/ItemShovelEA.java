		...
		implements IItemCharge, IBarHelper
{
	...
	public ItemShovelEA(EnumMatterTypesEA matterType, int numCharges, Properties props)
	{
	...
	{
		return ToolHelperEA.getDestroySpeed(super.getDestroySpeed(stack, state), matterType, getCharge(stack));
	}
